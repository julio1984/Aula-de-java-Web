...
<html>
    <head>
        ...
        <title>Sistema Gestao - Recuperar</title>
    ...
    <body class="h-100">
        <div><h1 style="text-align: center">Recuperção da senha</h1></div>
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <h4 class="text-center">Email do usuario</h4>
                                <form class="mt-5 mb-5 login-input" action="LoginServlet" method="POST" >
                                    <div class="form-group">
                                         <i class="fa fa-user fa-2x"></i> <span></span>
                                         <input type="email" class="form-control" placeholder="Digite seu email" name="email" required="true" />
                                    </div>
                                   
                                    <button class="btn login-form__btn submit w-100" type="submit">Enviar</button>
                                </form>
